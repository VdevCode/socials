...
document.querySelectorAll('.playlist').forEach(function (el) {
    el.addEventListener('click', function (e) {
        document.querySelector('.main-container').classList.remove("show");
        document.querySelector('.main-container').classList.remove("show,show1");
...
mhnUI = {
    ...
    datetime: function() {
        ...
        var h = n.getHours(),
            ...
            u = n.getSeconds(),
            l = "Sáng";
        h >= 12 && (l = "Chiều"), h > 12 && (h -= 12), 0 == h && (h = 12), 9 >= c && (c = "0" + c), 9 >= u && (u = "0" + u), $(".mhn-ui-date-time .mhn-ui-day").text(t[a]), $(".mhn-ui-date-time .mhn-ui-date").text(e[o] + " " + s + ", " + i), $(".mhn-ui-date-time .mhn-ui-time").text(h + ":" + c + " " + l), $(".mhn-ui-app-time").text(h + ":" + c + ":" + u + " " + l)
    },
    page: {
        show: function(t) {
